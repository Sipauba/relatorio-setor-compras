...
def frame_forn_comp(root) :
    ...
    label_fornecedor = Label(frame_forn_comp, text='FORNECEDOR', font=('Arial', 11))
    ...
    botao_fornecedor = Button(frame_forn_comp, text='...', width=1, height=1, bg='silver')
    botao_fornecedor.grid(row=1, column=1, padx=(0,0), sticky='w')

    label_comprador = Label(frame_forn_comp, text='COMPRADOR', font=('Arial', 11))
    ...
    botao_comprador = Button(frame_forn_comp, text='...', width=1, height=1, bg='silver')
